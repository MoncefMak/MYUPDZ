...
public class ArchiveFonctionnaireCommandVlidators : AbstractValidator<ArchiveFonctionnaireCommand>
{
    #region Fildes
    ...
    #region Construction
    public ArchiveFonctionnaireCommandVlidators(IRepositoryCategorie repositoryCategorie)
    {
